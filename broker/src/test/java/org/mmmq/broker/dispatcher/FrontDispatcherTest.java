...
class FrontDispatcherTest {
    ...
    void forwardMessageTest() {
        ...
        FrontDispatcher frontDispatcher = new FrontDispatcher(new DispatcherContainer(null, new ArrayList<>()));
        frontDispatcher.dispatcherContainer.dispatchers.add(dispatcher);
